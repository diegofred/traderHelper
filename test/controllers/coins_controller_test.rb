...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { binance_id: @coin.binance_id, coin_market_cap_id: @coin.coin_market_cap_id, cryptomkt_id: @coin.cryptomkt_id, name: @coin.name, symbol: @coin.symbol } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { binance_id: @coin.binance_id, coin_market_cap_id: @coin.coin_market_cap_id, cryptomkt_id: @coin.cryptomkt_id, name: @coin.name, symbol: @coin.symbol } }
